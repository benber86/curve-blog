...
function updateCharts(chain) {
    ...
    window.firstTimeUsersChart = createChart('firstTimeUsersChart', firstTimeUsersData[chain], ['% of users making a second transaction', 'per product']);
    window.percentageChart = createChart('percentageChart', percentageData[chain], ['% of all first time transactions', 'per product']);
}
